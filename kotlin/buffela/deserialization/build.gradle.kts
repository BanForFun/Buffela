...
kotlin {
    jvm()
    androidLibrary {
        namespace = "gr.elaevents.buffela.deserialization"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "deserialization", version.toString())

    pom {
        name = "Buffela deserialization utilities"
        description = "Utilities for buffela schema deserialization"
        inceptionYear = "2026"
