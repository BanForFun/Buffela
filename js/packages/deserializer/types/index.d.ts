...
export interface Deserializer<T, A extends CustomPrimitiveArgumentConfig> extends CustomPrimitiveConfig<A> {
    deserialize: (buffer: DeserializerBuffer, argument: CustomPrimitiveArgumentType<A>) => T
}
